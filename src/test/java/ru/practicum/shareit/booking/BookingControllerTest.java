...
public class BookingControllerTest {
    ...
    @Test
    void getIncorrectDateTimeExceptionTest() throws Exception {
        when(service.createBooking(any(Long.class), any(BookingCreationDto.class)))
                .thenThrow(IncorrectDateTimeException.class);
    ...
    @Test
    void getIncorrectStateExceptionTest() throws Exception {
        when(service.getBookingsByOwner(any(Long.class), any(String.class), any(Integer.class), any(Integer.class)))
                .thenThrow(IncorrectStateException.class);
